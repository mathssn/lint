...
public class Parser {
    ...
    public void parseStmt() {
        ...
        while (peek() != null) {
            if (peek().type.equals("KEYWORD") && peek().lexem.equals("var")) {
                Node newNode = parseDeclaration();
                nodes.add(newNode);
            }
            else if (peek().type.equals("IDENT")) {
                Node newNode = parseAssignment();
                nodes.add(newNode);
            }
            else if (peek().type.equals("KEYWORD") && peek().lexem.equals("if")) {
                ...
                if (peek() != null && peek().type.equals("SEMI_COL")) {
                    eat();
                    nodes.add(newNode);
                } else {
    ...
    public ArrayList<Node> parseBlock() {
        ...
        while (peek() != null && !peek().type.equals("RIGHT_BRACE")) {
            if (peek().type.equals("KEYWORD") && peek().lexem.equals("var")) {
                Node newNode = parseDeclaration();
                nodes.add(newNode);
            }
    ...
    public Node parseDeclaration() { // Faz o parse de uma declaração de variavel
        ...
        int line = peek().line; // Armazena a linha atual
        ...
        if (peek() != null && peek().type.equals("IDENT")) {
            ident = peek();
            eat();
        } else {
        ...
        if (peek() != null && peek().type.equals("ASSIGN_OP")) {
            eat();
        ...
        if (peek() == null || !peek().type.equals("COLON")) {
        ...
        if (peek() == null || !peek().type.equals("KEYWORD") || !tipos.contains(peek().lexem)) {
    ...
    public Node parseIfStmt() {
        ...
        if (peek().type.equals("KEYWORD") && peek().lexem.equals("if")) {
            eat();
        } else {
            throw new RuntimeException(String.format("Erro proximo a linha %d: Esperado 'if'", line));
        }

        if (peek() != null && peek().type.equals("LEFT_PAREN")) {
            eat();
        } else {
        ...
        if (peek() != null && peek().type.equals("RIGHT_PAREN")) {
            eat();
        } else {
        ...
        if (peek() != null && peek().type.equals("LEFT_BRACE")) {
            eat();
        } else {
        ...
        if (peek() != null && peek().type.equals("RIGHT_BRACE")) {
            eat();
        } else {
    ...
    public Node parseLogicExpr() {
        ...
        while (peek() != null && (peek().type.equals("AND_OP") || peek().type.equals("OR_OP"))) {
            Token operator = peek();
            eat();
    ...
    public Node parseLogicTerm() {
        ...
        if (peek() != null && logicOperators.contains(peek().type)) {
            Token operator = peek();
            eat();
            Node rightNode = parseExpr();
    ...
    public Node parseExpr() {
        ...
        while (peek() != null && (peek().type.equals("SUM_OP") || peek().type.equals("SUB_OP"))) {
    ...
    public Node parseTerm() {
        ...
        while (peek() != null && (peek().type.equals("MULT_OP") || peek().type.equals("DIV_OP"))) {
            // Se for um operador * ou /, faz o parse do lado direito
            Token operator = peek();
            eat();
    ...
    public Node parseFactor() {
        ...
        if (peek().type.equals("SUB_OP")) {
            eat();

            // Verifica se apos o operador vem um inteiro, um float ou uma variavel
            if (peek() != null && (peek().type.equals("INT_LIT") || peek().type.equals("FLOAT") || peek().type.equals("IDENT"))) {
        ...
        else if (peek().type.equals("LEFT_PAREN")) {
            eat();
        ...
        else if (peek().type.equals("INT_LIT")) {
            Node newNode = new Node("int", peek().lexem, null, null, null, null);
            eat();
            return newNode;
        }

        // Verifica se é um caractere
        else if (peek().type.equals("CHAR_LIT")) {
            Node newNode = new Node("char", peek().lexem, null, null, null, null);
            eat();
            return newNode;
        }

        // Verifica se é um float
        else if (peek().type.equals("FLOAT")) {
            Node newNode = new Node("float", peek().lexem, null, null, null, null);
            eat();
            return newNode;
        }

        // Verifica se é um booleano
        else if (peek().lexem.equals("True") || peek().lexem.equals("False")) {
            Node newNode = new Node("bool", peek().lexem, null, null, null, null);
            eat();
            return newNode;
        }

        // Verifica se é um ponteiro nulo
        else if (peek().lexem.equals("null")) {
        ...
        // Verifica se é um identificador
            ...
            Node newNode = new Node("ident", null, peek().lexem, null, null, null);
            eat();
            return newNode;
        }
